...
<form class="form-horizontal" id="signUpForm" action="loginS.php" style="margin-top:150px;" method='POST'>
      ...
      if($_POST['firstname'] && $_POST['pwd']){
        ...
        // }
            ...
            if(mysqli_affected_rows($conn) > 0){
                ...
                echo "<div align=center id='arl'>Đăng nhập không thành công!<div>";
                mysqli_free_result($result);
            }
