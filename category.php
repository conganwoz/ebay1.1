...
<?php
$url = "http://svcs.ebay.com/MerchandisingService?OPERATION-NAME=getMostWatchedItems&SERVICE-VERSION=1.0.0&CONSUMER-ID=AnLuu-itemFin-PRD-6820bcb98-498148e7&RESPONSE-DATA-FORMAT=JSON&maxResults=20&categoryId=".$id;
// $ch = curl_init($apical);
